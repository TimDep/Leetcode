        ...
        for (int i = 0; i < nums.length; i++) {
            for (int j = 0; j < nums.length; j++) {
                for (int k = 0; k < nums.length; k++) {
                    if (oplossing != target && j!= k && k!=i && i!=j) {
                        temp = nums[i] + nums[j] + nums[k];
                        if (Math.abs(temp - target) < Math.abs(oplossing - target)) {
                            oplossing = temp;
                        }
                    }
                }
